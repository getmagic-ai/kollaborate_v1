export default function CTA() {
  return (
    <div className='relative sm:py-16 mt-12'>
      ...
      <div className='mx-auto max-w-md sm:max-w-3xl lg:max-w-7xl lg:px-8'>
        <div className='relative overflow-hidden rounded-lg bg-indigo-600 px-6 py-10 shadow-xl sm:px-12 sm:py-20'>
          <div
            aria-hidden='true'
